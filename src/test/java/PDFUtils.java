...
public class PDFUtils {
    ...
    public static void test() {
        String filePath = "/Users/zhengzhisheng/workspace/中国成人血脂异常防治指南（2016年修订版）.pdf";
    ...
    public static List<String> pdfToImagePath(String filePath) {
        ...
        try {
            ...
            for (int i = 0; i < pageCount; i++) {
                ...
                // 方式2,第二个参数是设置缩放比(即像素)
//                BufferedImage image = renderer.renderImage(i, 100);  //第二个参数越大生成图片分辨率越高，转换时间也就越长
...
//                BufferedImage image = new PDFRenderer(pdf).renderImageWithDPI(i,100 , ImageType.RGB);
                piclist.add(image);
            }
...
//        pdf2multiImage("/Users/zhengzhisheng/workspace/国际严重脓毒症和脓毒性休克治疗指南2012完全版.pdf", "/Users/zhengzhisheng/study/46.png");
        test();
    }
}